...
//        searchButton.click(); // this will be unnecessary because of the Key.ENTER

        WebElement mainHeading = driver.findElement(By.cssSelector("#firstHeading"));

        if (mainHeading.getText().equals("Tesla")) System.out.println("Main title validation has PASSED");
        else System.out.println("Main title validation has FAILED");
